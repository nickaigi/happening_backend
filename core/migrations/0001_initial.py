...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_news', (
            ...
            ('story', self.gf('django.db.models.fields.TextField')(max_length=500)),
    ...
    models = {
        ...
        'core.news': {
            ...
            'story': ('django.db.models.fields.TextField', [], {'max_length': '500'}),
        ...
        'core.tag': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_edited': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'news': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.News']"}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
